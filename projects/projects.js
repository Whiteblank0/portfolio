...
// Declare projectsContainer in a wider scope, but initially undefined
...
  // Select the container for the projects and assign it to the wider scoped variable
  projectsContainer = document.querySelector('.projects'); // Assign value here
...
renderPieChart(projects); // Call renderPieChart after initial data is loaded and processed
...
        renderProjects(projects, projectsContainer, 'h2'); // projectsContainer is now in scope
      } else {
